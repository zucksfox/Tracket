...
<div class="max-w-2xl mx-auto space-y-5">
    <div>
        ...
        <h1 class="text-[20px] font-bold t-ink tracking-tight mt-1">Perbarui Data Akun Pengguna</h1>
        <p class="text-[12.5px] t-muted mt-0.5">Ubah identitas, peran, atau atur ulang kata sandi akun #USR-{{ str_pad($technician->id, 3, '0', STR_PAD_LEFT) }}.</p>
    </div>
        ...
        <form action="{{ route('technicians.update', $technician) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" id="password" name="password" minlength="8"
                    placeholder="isi untuk mengatur ulang kata sandi" class="field mono" autocomplete="new-password">
                <span class="text-[11px] t-muted mt-1 block">Biarkan kosong untuk mempertahankan kata sandi saat ini. Minimal 8 karakter bila diisi.</span>
            </div>
